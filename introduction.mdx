...
<CardGroup cols="2">
  <Card title="Edit Your mom" icon="pen-to-square" href="https://mintlify.com/docs/quickstart">
    Get your docs set up locally for easy development
  </Card>
  <Card title="Preview Changes HOOPLAH" icon="image" href="https://mintlify.com/docs/development">
    Preview hoopy your changes before you push to make sure they're perfect
  </Card>
</CardGroup>
